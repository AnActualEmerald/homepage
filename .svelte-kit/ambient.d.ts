...
declare module '$env/static/private' {
	...
	export const SUDO_PASSWORD: string;
	export const S6_CMD_WAIT_FOR_SERVICES_MAXTIME: string;
	export const LANGUAGE: string;
	export const NODE: string;
	export const CRYSTAL_PATH: string;
	export const npm_config_local_prefix: string;
	export const VSCODE_PROXY_URI: string;
	export const GPG_TTY: string;
	export const PROXY_DOMAIN: string;
	export const PWD: string;
	export const INSTALL_PACKAGES: string;
	...
	export const DOCKER_MODS: string;
