...
export function getSdk(requester) {
  return {
    story(variables, options) {
      return requester(StoryDocument, variables, options);
    },
    storyConnection(variables, options) {
      return requester(StoryConnectionDocument, variables, options);
    },
